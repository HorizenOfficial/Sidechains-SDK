 ...
 *
 * 3. ftMinAmount - Sidechain sends minimum FT amount as a parameter in a Certificate sent to Mainchain.
 ...
 *
 * 4. coinBoxMinAmount - we should prevent  creation of any kind of coin boxes on SC which value is too low,
