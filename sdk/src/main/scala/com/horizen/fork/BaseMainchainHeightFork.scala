...
class BaseMainchainHeightFork(val heights: McForkHeight) {
...
case class McForkHeight(mainnetHeight: Int, regtestHeight: Int, testnetHeight: Int){}
...
object BaseMainchainHeightFork {
  ...
  val DEFAULT_MAINCHAIN_FORK_HEIGHTS = McForkHeight(1047624, 420, 926225)
}
