  ...
  with SidechainTypes
{
  ...
  def getLastWithdrawalCertificatePreviousMcBlockHashOpt: Option[Array[Byte]] = storage.get(lastWithdrawalCertificatePreviousMcBlockHashKey).asScala.map(_.data)
