  ...
  extends Application  with ScorexLogging
{
  ...
  var coreApiRoutes: Seq[SidechainApiRoute] = Seq[SidechainApiRoute](
    ...
    SidechainTransactionApiRoute(settings.restApi, nodeViewHolderRef, sidechainTransactionActorRef, nodeViewSynchronizer, sidechainTransactionsCompanion, params),
