    ...
    )
{
  ...
  val sidechainBlockActorRef: ActorRef = SidechainBlockActorRef[PMOD, SidechainSyncInfo, SidechainHistory, SidechainState]("SidechainBlock", sidechainSettings, sidechainBlockForgerActorRef)
