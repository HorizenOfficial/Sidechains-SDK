  ...
  override def applyChanges(changes: BoxStateChanges[SidechainTypes#SCP, SidechainTypes#SCB],
    ...
    applicationState.onApplyChanges(this,
      ...
      case Success(appState) =>
        ...
        new SidechainState(
          stateStorage.update(version, withdrawalEpochInfo, boxesToUpdate, boxIdsToRemoveSet, withdrawalRequestsToAppend, containsBackwardTransferCertificate, forgingStakesToAppend, consensusEpoch).get,
          params,
          newVersion,
          appState
        )
