...
import com.horizen.secret.SecretsIdsEnum.{PrivateKey25519SecretId, VrfPrivateKeySecretId}
import com.horizen.secret.{PrivateKey25519Serializer, SecretSerializer, VrfSecretKeySerializer}
