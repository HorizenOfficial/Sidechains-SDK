...
import com.horizen.storage.{SidechainBlocks, SidechainSecretStorage, SidechainStateStorage, SidechainWalletBoxStorage, SidechainWalletTransactionStorage, TransactionIndexes}
...
class SidechainNodeViewHolder(sidechainSettings: SidechainSettings,
                              sidechainBlocksStorage: SidechainBlocks,
                              transactionIndexesStorage: TransactionIndexes,
  ...
  with SidechainTypes
{
  ...
  override def restoreState(): Option[(HIS, MS, VL, MP)] = for {
    history <- SidechainHistory.restoreHistory(sidechainBlocksStorage, transactionIndexesStorage, params, semanticBlockValidators(params), historyBlockValidators(params))
  ...
  override protected def genesisState: (HIS, MS, VL, MP) = {
    val result = for {
      history <- SidechainHistory.genesisHistory(sidechainBlocksStorage, transactionIndexesStorage, params, genesisBlock, semanticBlockValidators(params), historyBlockValidators(params))
...
object SidechainNodeViewHolderRef {
  def props(sidechainSettings: SidechainSettings,
    ...
    Props(new SidechainNodeViewHolder(sidechainSettings, sidechainBlocksStorage, transactionIndexesStorage, stateStorage, walletBoxStorage, secretStorage,
  ...
  def apply(sidechainSettings: SidechainSettings,
    ...
    system.actorOf(props(sidechainSettings, sidechainBlocksStorage, transactionIndexesStorage, stateStorage, walletBoxStorage, secretStorage,
      walletTransactionStorage, params, timeProvider, applicationWallet, applicationState, genesisBlock))
