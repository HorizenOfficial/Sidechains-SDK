...
object WellKnownAddresses {
  ...
  val FORGER_STAKEV2_SMART_CONTRACT_ADDRESS: Address = new Address("0x0000000000000000000022222222222222222333")
  ...
  val FORGER_STAKE_V3_SMART_CONTRACT_ADDRESS: Address = new Address("0x0000000000000000000022222222222222223333")
