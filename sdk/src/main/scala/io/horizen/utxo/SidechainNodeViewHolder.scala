...
class SidechainNodeViewHolder(sidechainSettings: SidechainSettings,
  ...
  override def restoreState(): Option[(HIS, MS, VL, MP)] = {
    ...
    val restoredData = for {
      ...
      state <- SidechainState.restoreState(stateStorage, forgerBoxStorage, utxoMerkleTreeProvider, params, applicationState, timeProvider)
  ...
  override protected def genesisState: (HIS, MS, VL, MP) = {
    val result = for {
      state <- SidechainState.createGenesisState(stateStorage, forgerBoxStorage, utxoMerkleTreeProvider, backupStorage, params, applicationState, genesisBlock, timeProvider)
