...
import static com.horizen.transaction.CoreTransactionsIdsEnum.SidechainCoreTransactionExtendedId;

import java.util.*;


public final class SidechainCoreTransactionExtended
        extends SidechainNoncedTransaction<Proposition, Box<Proposition>, BoxData<Proposition, Box<Proposition>>>
{
    public final static byte SIDECHAIN_CORE_TRANSACTION_EXTENDED_VERSION = 1;
    ...
    public SidechainCoreTransactionExtended(List<byte[]> inputsIds,
    ...
    public TransactionSerializer serializer() {
        return SidechainCoreTransactionExtendedSerializer.getSerializer();
    }
    ...
    public byte transactionTypeId() {
        return SidechainCoreTransactionExtendedId.id();
    }
