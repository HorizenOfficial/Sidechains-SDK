...
public class AccountBlockTest implements ReceiptFixture {
    ...
    public void receiptRoot() {
        ...
        var txData = new String[][]{{"ce5c2ec59ee419da7716fc5b4cacfeac721b74c34422e64b6c89d326bea3eb70","35348c6dabdd7a6ce31d80a277fb6374419ca07e"}, {"28ef52bffa96651fc6edcd9805d34db72816650cc1e5ae843c0dbf75efc7cd86","2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599"}, {"aace05db44ac4c317504c22f0c8535dcc88f54fce1064aab3be7b337414f0b43","c5b24870bef4db2ca306d3627dfc4a9e5dce78bf"}, {"8d693c2dafe2a66f60b47985c510111c9dc69ee4abe41ad31e3308765e929826", "06012c8cf97BEaD5deAe237070F9587f8E7A266d"}};
        var receiptList = Arrays.stream(txData).map((d) -> {
            ...
            return createTestEthereumReceipt(txType, numLogs, contractAddressPresence, Option.apply(BytesUtils.fromHexString(d[0])), BytesUtils.fromHexString(d[1]), "blockhash", 22, 33).consensusDataReceipt();
