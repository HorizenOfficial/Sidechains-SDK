...
class WebSocketCommunicationClientTest extends JUnitSuite with MockitoSugar {
          ...
          case "5" if reqId.get.length > 0 =>
            resp =
              mapper.createObjectNode()
                ...
                .put("requestId", reqId.get)
                .set("responsePayload", mapper.createObjectNode()
                  .set("mempool_top_quality_cert", mapper.createObjectNode()
                    .put("quality", 20)
  ...
  def sendWellFormedRequest() : Unit = {
    ...
    try {
      ...
      assertEquals(wellFormedTopQualityCertificateResponsePayload.mempool_top_quality_cert.get("quality").asInt(), 20)
      assertEquals(wellFormedTopQualityCertificateResponsePayload.mempool_top_quality_cert.get("certHash").asText(), "5df6a3f3603d19384435c9d54feb9dea1f4ea340bf4b60869889fcbf60843f82")
      assertEquals(wellFormedTopQualityCertificateResponsePayload.mempool_top_quality_cert.get("rawCertificateHex").asText(), "")
      assertEquals(wellFormedTopQualityCertificateResponsePayload.mempool_top_quality_cert.get("fee").asDouble(), 0.0, 0.01)
