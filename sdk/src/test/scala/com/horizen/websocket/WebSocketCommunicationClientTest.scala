...
class WebSocketCommunicationClientTest extends JUnitSuite with MockitoSugar {
  ...
  def sendWellFormedRequest() : Unit = {
    ...
    try {
      ...
      assertEquals(wellFormedTopQualityCertificateResponsePayload.mempoolTopQualityCert.quality.get, 20)
      ...
      assertEquals(0.0, wellFormedTopQualityCertificateResponsePayload.mempoolTopQualityCert.fee.get, 0.01)
