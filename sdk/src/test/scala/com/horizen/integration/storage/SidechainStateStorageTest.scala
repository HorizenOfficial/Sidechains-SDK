    ...
    with SidechainTypes
{
  ...
  def withdrawalRequestsFlow() : Unit = {
    ...
    assertTrue("No last withdrawal certificate previous McBlock expected to be defined", sidechainStateStorage.getLastWithdrawalCertificatePreviousMcBlockHashOpt.isEmpty)
    ...
    val mod1mcBlockHashInCertificate = Option(Array[Byte](1, 2, 3, 4, 5, 6 ,7))
    assertTrue("Update(insert) must be successful.",
    ...
    assertEquals(sidechainStateStorage.getLastWithdrawalCertificatePreviousMcBlockHashOpt, mod1mcBlockHashInCertificate)
    ...
    val mod2mcBlockHashInCertificate = Option(Array[Byte](1, 2, 3, 4, 5, 6 ,7))
    assertTrue("Update(insert) must be successful.",
    ...
    assertEquals(sidechainStateStorage.getLastWithdrawalCertificatePreviousMcBlockHashOpt.get.deep, mod2mcBlockHashInCertificate.get.deep)
    ...
    assertEquals(sidechainStateStorage.getLastWithdrawalCertificatePreviousMcBlockHashOpt.get.deep, mod1mcBlockHashInCertificate.get.deep)
  }
