...
class ActiveChainTest extends JUnitSuite with SidechainBlockInfoFixture {
  ...
  def addBlockWithMainchainRefDataAfterMainchainHeaders(): Unit = {
    ...
    val mcCumulativeHash1: Array[Byte] = FieldElementFixture.generateFieldElementBigEndian()
    ...
    val mcCumulativeHash2: Array[Byte] = FieldElementFixture.generateFieldElementBigEndian()
    val mcHash3: MainchainHeaderHash = byteArrayToMainchainHeaderHash(generateBytes())
    val mcCumulativeHash3: Array[Byte] = FieldElementFixture.generateFieldElementBigEndian()
    ...
    val mcCumulativeHash4: Array[Byte] = FieldElementFixture.generateFieldElementBigEndian()
    val mcHash5: MainchainHeaderHash = byteArrayToMainchainHeaderHash(generateBytes())
    val mcCumulativeHash5: Array[Byte] = FieldElementFixture.generateFieldElementBigEndian()
    val mcHash6: MainchainHeaderHash = byteArrayToMainchainHeaderHash(generateBytes())
    val mcCumulativeHash6: Array[Byte] = FieldElementFixture.generateFieldElementBigEndian()
    ...
    val mcCumulativeHash7: Array[Byte] = FieldElementFixture.generateFieldElementBigEndian()
    ...
    val mcCumulativeHash8: Array[Byte] = FieldElementFixture.generateFieldElementBigEndian()
