...
class MainchainBlockReferenceTest extends JUnitSuite {
  ...
  def blocksWithScSupportParsing_TxWithScCreationAndFt(): Unit = {
    ...
    assertEquals("SCMap Merkle root hash is different.", "5e3add878e57f80c2d14822ecd50d50cd210cb22f2707739e40247ee04507126", BytesUtils.toHexString(mcblock.header.hashScTxsCommitment))
  ...
  def blocksWithScSupportParsing_MultipleScOutputs(): Unit = {
    ...
    assertEquals("SCMap Merkle root hash is different.", "b1c03111552c8f8ee37143baa1b7ff00636511b0189b02a2a917e6110efb58c3", BytesUtils.toHexString(mcblock.header.hashScTxsCommitment))
