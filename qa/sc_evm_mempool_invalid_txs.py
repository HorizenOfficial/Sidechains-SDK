...
class SCEvmMempoolInvalidTxs(SidechainTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(0, len(response), "Transaction with negative nonce added to node 1 mempool")
        ...
        response = allTransactions(sc_node_1)
        assert_equal(0, len(response), "Transaction with negative value added to node 1 mempool")
        ...
        response = allTransactions(sc_node_1)
        assert_equal(0, len(response), "Transaction  with max fee lower than priority fee added to node 1 mempool")
        ...
        # response = allTransactions(sc_node_1)
        # assert_equal(0, len(response), "Transaction with max fee with more than 256 bits added to node 1 mempool")
        ...
        response = allTransactions(sc_node_1)
        assert_equal(0, len(response), "Transaction with gas limit with more than 64 bitsadded to node 1 mempool")
        ...
        response = allTransactions(sc_node_1)
        assert_equal(0, len(response), "Transaction with gas limit > block gas limit added to node 1 mempool")
        ...
        response = allTransactions(sc_node_1)
        assert_equal(0, len(response), "Transaction that creates a smart contract with empty data added to node 1 mempool")
        ...
        response = allTransactions(sc_node_1)
        assert_equal(0, len(response), "Transaction with gas limit < intrinsic gas added to node 1 mempool")
        ...
        response = allTransactions(sc_node_1)
        assert_equal(0, len(response), "Transaction with nonce too low  added to node 1 mempool")
