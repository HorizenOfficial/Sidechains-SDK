...
from SidechainTestFramework.scutil import (
    ...
    convertZenToWei, convertZenToZennies, convertZenniesToWei, generate_next_block, get_account_balance, SLOTS_IN_EPOCH,
    EVM_APP_SLOT_TIME,
)
...
class SCEvmForger(AccountChainSetup):
    ...
    def run_test(self):
        ...
        assert_equal(
            get_account_balance(sc_node_1, FORGER_STAKE_SMART_CONTRACT_ADDRESS),
            get_account_balance(sc_node_2, FORGER_STAKE_SMART_CONTRACT_ADDRESS))
        ...
        assert_equal(convertZenniesToWei(stakeAmount), get_account_balance(sc_node_1, FORGER_STAKE_SMART_CONTRACT_ADDRESS),
        ...
        forgerStakes = {"forgerStakeInfo": {
            "ownerAddress": WITHDRAWAL_REQ_SMART_CONTRACT_ADDRESS,  # SC node 1 is an owner
        ...
        assert_equal(
            convertZenToWei(forgerStake1_amount) +
            convertZenToWei(forgerStake2_amount),
            get_account_balance(sc_node_1, FORGER_STAKE_SMART_CONTRACT_ADDRESS), "Contract address balance is wrong.")
