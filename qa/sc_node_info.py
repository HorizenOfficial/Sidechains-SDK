...
class SCNodeInfo(SidechainTestFramework):
    ...
    def run_test(self):
        ...
        assert_true(node_info_1['scType'], 'ceasing')
        ...
        assert_equal(node_info_1['lastCertQuality'], 7)
        ...
        assert_true(node_info_2['scType'], 'ceasing')
        ...
        assert_equal(node_info_2['lastCertQuality'], 7)
