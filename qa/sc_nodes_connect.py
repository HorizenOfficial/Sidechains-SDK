...
class SidechainNodesConnectionTest(SidechainTestFramework):
    ...
    #TO DO: Move generate genesis addresses to Scorex Fork code, it doesn't make sense to initialize in a test
    ...
    def check_genesis_balances(self, node, nodename, nodenumber):
