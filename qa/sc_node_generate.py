...
class SidechainNodeBlockGenerationTest(SidechainTestFramework):
    ...
    def setup_network(self, split = False):
        ...
        self.nodes[0].generate(101) #Simple test, don't need particular things
        self.sync_all()
    ...
    def run_test(self):
        ...
        assert_equal(mcnode2newbalance, mcnode2balance + mc_fee + blockreward, "Coins received/total amount mismatch for MC Node2")
        print("-->MC Node 0 new balance: {0}".format(mcnode0newbalance))
        print("-->MC Node 1 new balance: {0}".format(mcnode1newbalance))
        print("-->MC Node 2 new balance: {0}".format(mcnode2newbalance))
        scblockreward = 1
