...
class SCEvmNodeInfo(AccountChainSetup):
    ...
    def run_test(self):
        ...
        assert_true(node_info_1['scId'], "scId should be present")
        assert_true(node_info_1['scType'], 'non ceasing')
        ...
        assert_true(node_info_1['scWithdrawalEpochLength'], 10)
        assert_equal(node_info_1['scWithdrawalEpochNum'], 1)
        assert_true(node_info_1['scEnv'], 'regtest')
        assert_true(node_info_1['lastMcBlockReferenceHash'], "lastMcBlockReferenceHash should be present")
        ...
        assert_true(node_info_1['maxMemPoolSlots'], 6144)
        ...
        assert_equal(node_info_1['lastCertBtrFree'], 0)
        ...
        assert_true(node_info_2['scId'], "scId should be present")
        assert_true(node_info_2['scType'], 'non ceasing')
        ...
        assert_true(node_info_2['scWithdrawalEpochLength'], 10)
        assert_equal(node_info_2['scWithdrawalEpochNum'], 1)
        assert_true(node_info_2['scEnv'], 'regtest')
        assert_true(node_info_2['lastMcBlockReferenceHash'], "lastMcBlockReferenceHash should be present")
        ...
        assert_true(node_info_2['maxMemPoolSlots'], 6144)
        ...
        assert_equal(node_info_2['lastCertBtrFree'], 0)
