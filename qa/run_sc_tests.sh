...
testScripts=(
    ...
    'sc_backward_transfer.py --certcircuittype=0'
    'sc_backward_transfer.py --certcircuittype=1'
    'sc_blockid_for_backup.py'
    'sc_bootstrap.py'
    'sc_bt_limit.py --certcircuittype=0'
    'sc_bt_limit.py --certcircuittype=1'
    'sc_bt_limit_across_fork.py --certcircuittype=0'
    'sc_bt_limit_across_fork.py --certcircuittype=1'
    'sc_bwt_minimum_value.py --certcircuittype=0'
    'sc_bwt_minimum_value.py --certcircuittype=1'
    'sc_ceased.py'
    'sc_cert_fee_conf.py'
    'sc_cert_no_coin_record.py'
    'sc_cert_submission_decentralization.py --certcircuittype=0'
    'sc_cert_submission_decentralization.py --certcircuittype=1'
    'sc_cert_submitter_after_sync_1.py --certcircuittype=0'
    'sc_cert_submitter_after_sync_1.py --certcircuittype=1'
    'sc_cert_submitter_after_sync_2.py --certcircuittype=0'
    'sc_cert_submitter_after_sync_2.py --certcircuittype=1'
    'sc_closed_forger.py'
    ...
    'sc_multiple_certs.py --certcircuittype=0'
    'sc_multiple_certs.py --certcircuittype=1'
    'sc_node_api_test.py'
