...
class SidechainTestFramework(BitcoinTestFramework):
    ...
    def main(self):
        ...
        parser.add_option("--scjarpath", dest="scjarpath", default="../target/Sidechains-SDK-0.1-SNAPSHOT.jar com.horizen.SidechainApp", #New option. Main class path won't be needed in future
                          help="Directory containing .jar file for SC (default: %default)")
        parser.add_option("--tmpdir", dest="tmpdir", default="../target/tmp",
