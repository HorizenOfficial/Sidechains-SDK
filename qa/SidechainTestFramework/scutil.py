...
def launch_bootstrap_tool(command_name, json_parameters):
    ...
    java_ps = subprocess.Popen(["java", "-jar",
                                os.getenv("SIDECHAIN_SDK",
                                          "..") + "/tools/sctool/target/sidechains-sdk-scbootstrappingtools-0.7.1-SNAPSHOT.jar",
...
SIMPLE_APP_BINARY = get_examples_dir() + "/simpleapp/target/sidechains-sdk-simpleapp-0.7.1-SNAPSHOT.jar" + get_lib_separator() + get_examples_dir() + "/simpleapp/target/lib/* io.horizen.examples.SimpleApp"
EVM_APP_BINARY = get_examples_dir() + "/evmapp/target/sidechains-sdk-evmapp-0.7.1-SNAPSHOT.jar" + get_lib_separator() + get_examples_dir() + "/evmapp/target/lib/* io.horizen.examples.EvmApp"
