...
func TestInvokeDelegatecall(t *testing.T) {
	...
	//=====CONTRACTS DEPLOY=====
	deployReceiverResult := call(t, instance, "EvmApply", lib.EvmParams{
		HandleParams: lib.HandleParams{Handle: handle},
		From:         user,
		To:           nil,
	...
	getReceiverCode := call(t, instance, "StateGetCode", lib.AccountParams{
		HandleParams: lib.HandleParams{Handle: handle},
	...
	deployCallerResult := call(t, instance, "EvmApply", lib.EvmParams{
		HandleParams: lib.HandleParams{Handle: handle},
		From:         user,
		To:           nil,
	...
	getCallerCode := call(t, instance, "StateGetCode", lib.AccountParams{
		HandleParams: lib.HandleParams{Handle: handle},
	...
	//retrieve value
	receiverTestResult := call(t, instance, "EvmApply", lib.EvmParams{
		HandleParams: lib.HandleParams{Handle: handle},
		From:         user,
		To:           deployReceiverResult.ContractAddress,
	...
	//retrieve value
	callerTestResult := call(t, instance, "EvmApply", lib.EvmParams{
		HandleParams: lib.HandleParams{Handle: handle},
		From:         user,
		To:           deployCallerResult.ContractAddress,
