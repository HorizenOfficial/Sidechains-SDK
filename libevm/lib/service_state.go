...
var chunkKeySalt = common.HexToHash("fa09428dd8121ea57327c9f21af74ffad8bfd5e6e39dc3dc6c53241a85ec5b0d")
...
func getChunkKey(key common.Hash, chunkIndex int) common.Hash {
	return crypto.Keccak256Hash(chunkKeySalt.Bytes(), key.Bytes(), common.BigToHash(big.NewInt(int64(chunkIndex))).Bytes())
}
