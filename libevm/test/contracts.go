...
// findSignature iterates the lines of s Signatures file generated by the Solidity compiler
...
func StorageContractDeploy(initialValue *big.Int) []byte {
	return append(common.Hex2Bytes(storageDeployCode), common.BigToHash(initialValue).Bytes()...)
}

func StorageContractRuntimeCode() []byte {
	return common.Hex2Bytes(storageRuntimeCode)
}
...
func OpCodesContractDeploy() []byte {
	return common.Hex2Bytes(opCodesDeployCode)
}

func OpCodesContractRuntimeCode() []byte {
	return common.Hex2Bytes(opCodesRuntimeCode)
}
