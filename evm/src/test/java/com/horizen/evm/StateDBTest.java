...
public class StateDBTest {
    ...
    public void TestAccountManipulation() throws Exception {
        ...
        byte[] origin = Converter.fromHexString("bafe3b6f2a19658df3cb5efca158c93272ff5c0b");
    ...
    public void TestEvmExecution() throws Exception {
        ...
        byte[] codeHash = Converter.fromHexString("aa87aee0394326416058ef46b907882903f3646ef2a6d0d20f9e705b87c58c77");

        byte[] addr1 = Converter.fromHexString("1234561234561234561234561234561234561230");
        byte[] addr2 = Converter.fromHexString("bafe3b6f2a19658df3cb5efca158c93272ff5c0b");
