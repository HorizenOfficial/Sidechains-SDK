...
class WebSocketCommunicationClientTest extends JUnitSuite with MockitoSugar {
  ...
  def sendWellFormedRequest() : Unit = {
    ...
    val wellFormedGetBlockByHashRequestPayload : RequestPayload = GetBlockByHashRequestPayload("0372229473df1b966945e2b307b86bd856323a54c645ccb91cabd1a49d8f87bf") // request type -> 1
    ...
    try {
      ...
      val future_2 : Future[BlockResponsePayload] = webSocketClient.sendRequest[RequestPayload, BlockResponsePayload](1, wellFormedGetBlockByHashRequestPayload, classOf[BlockResponsePayload])
  ...
  def sendRequestWithMalformedType() : Unit = {
    ...
    try {
      ...
      //val tryFut = future_1.value.get
      //assertTrue(tryFut.isFailure)
//      assertTrue("Error is not related to a request with invald type.")
  ...
  @Test
  def sendMalformedRequestWithType() : Unit = {

  }

  @Test
  def sendWellFormedRequestWithMalformedResponseType() : Unit = {
  ...
  @Test
  def receiveEventWithoutHandler() : Unit = {

  }

  @Test
  def receiveEventWithHandler() : Unit = {

  }

  @Test
  def receiveMultipleEvents() : Unit = {
